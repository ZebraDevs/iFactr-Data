        ...
        internal static string NameInArchive(String filename, string directoryPathInArchive)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    result = MonoCross.Utilities.Compatibility.Path.Combine(directoryPathInArchive, System.IO.Path.GetFileName(filename));
                }
            }
        ...
        private static ZipEntry Create(string nameInArchive, ZipEntrySource source, Object arg1, Object arg2)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    entry._LocalFileName = MonoCross.Utilities.Compatibility.Path.GetFullPath(filename); // workitem 8813

                }
                catch (Exception ptle)
                {
                    // workitem 14035
