...
using Path = MonoCross.Utilities.Compatibility.Path;
...
namespace Ionic.Zip
{
    ...
    IDisposable
    {
        ...
        public static System.Version LibraryVersion
        {
            get
            {
                return new AssemblyName(typeof(ZipFile).GetTypeInfo().Assembly.FullName).Version;
            }
        }
        ...
        internal Stream ReadStream
        {
            get
            {
                if (_readstream == null)
                {
                    ...
                    {
                        _readstream = File.OpenRead(_readName ?? _name);
